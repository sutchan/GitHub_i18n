...
const config = {
    ...
    reportFile: path.resolve(__dirname, '../docs/终极Markdown格式修复报告.md'),
    backupDir: path.resolve(__dirname, '../docs/_backup/ultimate_markdown_fix')
};
...
function fixTitleFormat(content) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (h1Match && firstH1Index === -1) {
            firstH1Index = i;
            firstH1Title = h1Match[1];
            break;
        }
    }
