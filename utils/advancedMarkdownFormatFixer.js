...
const config = {
    ...
    reportFile: path.resolve(__dirname, '../docs/高级Markdown格式修复报告.md'),
    backupDir: path.resolve(__dirname, '../docs/_backup/advanced_markdown_fix')
};
