...
(function () {
    ...
    const TRANSLATION_DICT = {
        ...
        'Scheduled digest': '定时摘要',
        'Notification preferences': '通知偏好设置',
        'Automatic watching': '自动关注',
        'Notifications from': '来自...的通知',
        'Notification sound': '通知声音',
        'Notification preview': '通知预览',
        'Notification tone': '通知音调',
        'Notification grouping': '通知分组',
        'Notification priority': '通知优先级',
        'Notification quiet hours': '通知安静时段',
        'Do not disturb': '请勿打扰',
        'Muted repositories': '已静音仓库',
        'Muted threads': '已静音线程',
        'Unmute all': '取消全部静音',
        'Notification history': '通知历史',
        'Notification archive': '通知归档',
        'Restore from archive': '从归档恢复',
        'Permanently delete': '永久删除',
        'Empty archive': '清空归档',
        'Notification search results': '通知搜索结果',
        'No notifications found': '未找到通知',
        'Load more notifications': '加载更多通知',
        ...
        'Notification unsaved': '通知已取消保存',
        'Notification muted': '通知已静音',
        'Notification unmuted': '通知已取消静音',
        'All notifications marked as read': '所有通知已标记为已读',
        'Notifications are being updated': '通知正在更新',
        'Notifications updated': '通知已更新',
        'Notification delivery failed': '通知送达失败',
        'Retry notification delivery': '重试通知送达',
        'Notification thread': '通知线程',
        'Start new thread': '开始新线程',
        'Subscribe to thread': '订阅线程',
        'Unsubscribe from thread': '取消订阅线程',
        'Thread activity': '线程活动',
        'Thread participants': '线程参与者',
        'Thread mentions': '线程提及',
        'Thread history': '线程历史',
        'Thread statistics': '线程统计',
        'Notification badge': '通知标记',
        'Notification count': '通知数量',
        'Unread count': '未读数量',
        'New notifications': '新通知',
        'Recent notifications': '最近通知',
        'Important notifications': '重要通知',
        'Critical notifications': '紧急通知',
        'Security notifications': '安全通知',
        'Maintenance notifications': '维护通知',
        'System notifications': '系统通知',
        'Account notifications': '账户通知',
        'Billing notifications': '账单通知',
        'Support notifications': '支持通知',
        'Marketing notifications': '营销通知',
        'Promotional notifications': '促销通知',
        'Personalized notifications': '个性化通知',
        'Recommended notifications': '推荐通知',
        'Related notifications': '相关通知',
        'Similar notifications': '类似通知',
        'Notification summary': '通知摘要',
        'Notification highlights': '通知亮点',
        'Notification trends': '通知趋势',
        'Notification analytics': '通知分析',
        'Notification insights': '通知洞察',
        'Notification preferences updated': '通知偏好已更新',
        'Notification settings updated': '通知设置已更新',
        'Notification delivery settings': '通知送达设置',
        'Notification appearance': '通知外观',
        'Notification behavior': '通知行为',
        'Notification timing': '通知时机',
        ...
        'Manage custom filters': '管理自定义筛选器',
        'Notification categories': '通知类别',
        'Notification types': '通知类型',
        'Notification sources': '通知来源',
        'Notification priorities': '通知优先级',
        'Notification templates': '通知模板',
        'Custom notification messages': '自定义通知消息',
        'Notification branding': '通知品牌',
        'Notification localization': '通知本地化',
        'Notification language': '通知语言',
        'Notification timezone': '通知时区',
        'Notification date format': '通知日期格式',
        'Notification time format': '通知时间格式',
        'Notification accessibility': '通知无障碍',
